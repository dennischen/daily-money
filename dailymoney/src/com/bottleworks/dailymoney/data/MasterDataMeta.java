...
public class MasterDataMeta {
    ...
    public static final String COL_BOOK_SYMBOL_INFRONT = "si_";
    public static final String COL_BOOK_NOTE = "nt_";
    

    public static final String[] COL_BOOK_ALL = new String[] { COL_BOOK_ID, COL_BOOK_NAME, COL_BOOK_SYMBOL, COL_BOOK_SYMBOL_INFRONT,COL_BOOK_NOTE};
