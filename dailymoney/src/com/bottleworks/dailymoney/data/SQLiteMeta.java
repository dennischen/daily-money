...
public class SQLiteMeta {
    ...
    public static final String COL_DET_FROM_DISPLAY = "fdp_";
    public static final String COL_DET_TO = "to_";
    public static final String COL_DET_TO_DISPLAY = "tdp_";
    ...
    public static final String[] COL_DET_ALL = new String[] { COL_DET_ID, COL_DET_FROM, COL_DET_FROM_DISPLAY,
            COL_DET_TO, COL_DET_TO_DISPLAY, COL_DET_DATE, COL_DET_MONEY, COL_DET_NOTE, COL_DET_ARCHIVED };
}
