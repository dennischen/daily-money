...
public class DataCreator {
    ...
    public void createTestData(){
        ...
        createDetail(asset1,asset2,Calendars.dateBefore(today,9),4000D,"deposit...");
        createDetail(asset2,asset1,Calendars.dateBefore(today,15),1000D,"drawing...");
        
    }
    
    
    private Detail createDetail(Account from,Account to,Date date,Double money,String note){
        Detail det = new Detail(from.getId(),from.getName(),to.getId(),to.getName(),date,money,note);
        idp.newDetail(det);
        return det;
    }
